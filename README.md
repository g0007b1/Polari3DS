...
P.S. Также настроил сборку через github actions, можно форкать проект, вносить изменения и билд будет сразу выдавать boot.firm который нужно просто заменить в корне sd карты с прошивкой. Не нужно заморачиваться с билдом изменений вручную.
